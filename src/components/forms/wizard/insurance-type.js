        ...
        <React.Fragment>
            ...
            <div className="row">
                <div className="col-md-12 text-center">
                    <Formik initialValues={insuranceInitialSchema}
                            ...
                            <div className="field-with-label">
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-6 mb-3 offset-3">
                                        ...
                                        <Field name="insurance_type" placeholder="purpose of insurance"
                                    ...
                                    <React.Fragment>
                                        ...
                                        <div className="col-md-6 mb-3 offset-3">
                                            ...
                                            <Field name="bank_account" placeholder="Sequence number"
